...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        KC_NO,                  KC_Q,                   KC_W,                   KC_E,           KC_R,           KC_T,       RGB_M_P,    KC_SLEP,    KC_Y,           KC_U,           KC_I,           KC_O,               KC_P,               KC_LBRC,
        KC_NO,                  LGUI_T(KC_A),           LALT_T(KC_S),           LCTL_T(KC_D),   LSFT_T(KC_F),   KC_G,       RGB_M_B,    KC_BRIU,    KC_H,           RSFT_T(KC_J),   RCTL_T(KC_K),   RALT_T(KC_L),       RGUI_T(KC_SCLN),    KC_QUOT,
        KC_NO,                  KC_Z,                   KC_X,                   KC_C,           KC_V,           KC_B,       RGB_TOG,    KC_BRID,    KC_N,           KC_M,           KC_COMM,        KC_DOT,             KC_SLSH,            KC_NO,

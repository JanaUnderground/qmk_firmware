...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        KC_NO,      KC_NO,          KC_NO,          KC_NO,          KC_ESC,         LT(2,KC_SPC),KC_TAB,    LT(3,KC_ENT),LT(1,KC_BSPC), KC_DEL,         KC_NO,          KC_NO,          KC_NO,              KC_NO
    ),
        [1] = LAYOUT(
        ...
        KC_TRNS,    KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_P0,      KC_TRNS,    KC_TRNS,    KC_TRNS,        KC_TRNS,            KC_TRNS,            KC_TRNS,            KC_TRNS,            KC_TRNS
    ),
        [2] = LAYOUT(
        KC_TRNS,    KC_TRNS,            KC_TRNS,        KC_TRNS,        KC_TRNS,            KC_TRNS,                                KC_TRNS,    KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
        ...
        KC_TRNS,    LSFT(KC_2),         RALT(KC_MINS),  LCTL_T(KC_RBRC),LSFT_T(KC_MINS),    LSFT(KC_GRV),   KC_TRNS,    KC_TRNS,    RALT(KC_7), LSFT(KC_7),     RALT(KC_NUBS),  LSFT(KC_RBRC),  LSFT(KC_MINS),  KC_TRNS,
        KC_TRNS,    LSFT(KC_NUHS),      KC_GRV,         LSFT(KC_EQL),   KC_TRNS,            KC_TRNS,        KC_TRNS,    KC_TRNS,    KC_NUBS,    LSFT(KC_NUBS),  KC_NUHS,        RALT(KC_EQL),   KC_EQL,         KC_TRNS,
